...
import com.summer.base.listener.view.DoubleClickListener;
...
public class BottomItemView extends ViewPager {
    ...
    public static class MenuAdapter extends PagerAdapter implements OnClickListener {
        ...
        int[] images = new int[]{R.drawable.ic_launcher_background, R.drawable.ic_launcher_background, R.drawable.ic_launcher_background};
